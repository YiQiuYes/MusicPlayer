...
class SalomonNavigationRail extends StatelessWidget {
  ...
  final List<SalomonNavigationRailItem> items;
                            ...
                            ClipRect(
                              ...
                              child: SizedBox(
                                ...
                                child: Align(
                                  ...
                                  widthFactor: t,
                                  child: Padding(
                                    padding: items.indexOf(item) > currentIndex
                                        ? EdgeInsets.only(
...
/// A tab to display in a [SalomonNavigationRailItem]
class SalomonNavigationRailItem {
  /// An icon to display.
  final Widget icon;
